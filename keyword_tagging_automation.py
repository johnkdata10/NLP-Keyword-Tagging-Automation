# -*- coding: utf-8 -*-
"""
Created on Mon Jul 26 10:07:27 2021
...
df = pd.read_csv("C:/Users/KRAMAJM/dataset.csv", encoding = "ISO-8859-1") 
df = df.astype(str)
df["event_summary"] = df["event_summary"].str.lower()

#####dictionary
virtus_dict = pd.read_excel("C:/Users/USERNAME/Dictionary_Long.xlsx")
...
data_filtered = "C:/Users/KRAMAJM/dataset.csv"
dictionary = "C:/Users/KRAMAJM/Dictionary_Long.xlsx"
